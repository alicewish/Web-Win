...
/*
@@@BUILDINFO@@@ Image Processor.jsx 1.0.0.12
*/
...
<about>$$$/JavaScripts/ImageProcessor/About=Image Processor^r^rCopyright 2007 Adobe Systems Incorporated. All rights reserved.^r^rProcesses multiple input and output files.</about>
...
function ImageProcessor() {
	...
	this.CreateDialog = function() {
		...
		if ( this.runningFromBridge ) {
			...
			d.rbUseOpen = l.grp1Info.grpRight.add( 'radiobutton', undefined, strUseOpen );
		...
		d.rbSaveInSame = l.grp2Info.grpRight.add( 'radiobutton', undefined, strSaveInSameLocation );
...
// Use this to retrieve the current files from the Bridge application
// I don't use it as I run differently only when called from the Bridge
// see photoshop.jsx
...
// we want the current open documents that have a path
