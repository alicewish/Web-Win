  ...
  */
	 ...
	 */
	 	...
	 	function initTextExport() {
			...
			{			
				var runMultiple = confirm("检测到多个文件.\n是否在所有文件上运行?", true, "TextExport");
			...
			for (var i = 0; i < docs.length; i++)
			{
				...
				if ( (runMultiple !== true) && (useDialog === true) )
				{
					...
					// Pop up save dialog
					var saveFile = File.saveDialog("请选择输出的文件:");
				...
				fileOut.writeln("* 开始输出文本 " + docs[i].name);
				fileOut.writeln("");
