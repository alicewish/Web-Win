...
// Export the second and third artboard to SWF files.
var destFolder = Folder.selectDialog('Select the folder to export the SWF files to:');
if (destFolder) {
	var destFile = new File(destFolder + '/ExportedArtboard');	
	var swfExportOptions = new ExportOptionsFlash();
	swfExportOptions.saveMultipleArtboards = true;
	swfExportOptions.artboardRange = "2-3";
	docRef.exportFile (destFile, ExportType.FLASH, swfExportOptions);	
}	